...
contextBridge.exposeInMainWorld('api', {
  ...
  saveSettings: (settings: object) => ipcRenderer.invoke('saveSettings', settings),
  changePassword: (data: {currentPassword: string, newPassword: string}) => ipcRenderer.invoke('changePassword', data),
  exportAllGrades: () => ipcRenderer.invoke('exportAllGrades')
})
